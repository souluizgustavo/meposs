...
<nav id="sidebar">
    <div id="newlog">
        ...
        <div class="title1">
            <?= $configuration['app_theme'] == 'white' ||  $configuration['app_theme'] == 'whitegreen' ? '<img src="' . base_url() . 'assets/img/aditiva-horiz-preto-2.png">' : '<img src="' . base_url() . 'assets/img/aditiva-horiz-branco-2.png">'; ?>
        </div>
    </div>
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vCliente')) { ?>
                    <li class="<?php if (isset($menuClientes)) {
                        ...
                        <a class="tip-bottom" title="" href="<?= site_url('clientes') ?>"><i class='bx bx-user iconX'></i>
                            ...
                            <span class="title-tooltip">Solicitantes</span>
                        </a>
                    </li>
                <?php } ?>
