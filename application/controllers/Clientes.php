...
class Clientes extends MY_Controller
{
    ...
    public function adicionar()
    {
        if (!$this->permission->checkPermission($this->session->userdata('permissao'), 'aCliente')) {
            $this->session->set_flashdata('error', 'Você não tem permissão para adicionar Solicitantes.');
            redirect(base_url());
        }
    ...
    public function editar()
    {
        ...
        if (!$this->permission->checkPermission($this->session->userdata('permissao'), 'eCliente')) {
            $this->session->set_flashdata('error', 'Você não tem permissão para editar Solicitantes.');
            redirect(base_url());
        }
        ...
        if ($this->form_validation->run('clientes') == false) {
            ...
            if ($this->clientes_model->edit('clientes', $data, 'idClientes', $this->input->post('idClientes')) == true) {
                ...
                log_info('Alterou um Solicitante. ID' . $this->input->post('idClientes'));
    ...
    public function visualizar()
    {
        ...
        if (!$this->permission->checkPermission($this->session->userdata('permissao'), 'vCliente')) {
            $this->session->set_flashdata('error', 'Você não tem permissão para visualizar Solicitantes.');
            redirect(base_url());
        }
    ...
    public function excluir()
    {
        if (!$this->permission->checkPermission($this->session->userdata('permissao'), 'dCliente')) {
            $this->session->set_flashdata('error', 'Você não tem permissão para excluir Solicitantes.');
            redirect(base_url());
        }
